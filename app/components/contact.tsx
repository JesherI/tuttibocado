        ...
        <section className="bg-[#03677a] text-white py-16 px-4 md:px-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="w-full md:w-1/2 h-[400px]">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2522.45770913285!2d-98.14871306576393!3d19.402527574577018!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d021004325fc41%3A0xe7a49aa99406ced0!2sTutti%20Bocado!5e0!3m2!1ses!2smx!4v1746742546996!5m2!1ses!2smx" width="600" height="450" className="border-0 rounded-xl" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                </div>
